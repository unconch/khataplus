  ...
  return (
    <div className="min-h-svh w-full flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-zinc-950 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col w-full p-16 text-white">
          ...
          <div className="space-y-12">
            ...
            <div
              className="grid grid-cols-1 gap-6 animate-in fade-in slide-up duration-700 delay-[400ms]"
            >
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-zinc-50 dark:bg-zinc-950 relative overflow-hidden">
        ...
        <div
          className="w-full max-w-md space-y-8 relative z-10 animate-in fade-in slide-up duration-700"
        >
          {!isSuccess ? (
            <div
              key="signup-form"
              className="space-y-8 animate-in fade-in slide-right duration-500"
            >
              ...
              <form onSubmit={handleSignUp} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  {password.length > 0 && (
                    <div
                      className="space-y-1.5 pt-1 pl-1 animate-in fade-in slide-up duration-300"
                    >
            ...
            <div
              key="success-message"
              className="text-center space-y-6 py-8 animate-in fade-in scale-in duration-500"
            >
