...
export default async function DedicatedPosPage(
    ...
    return (
        ...
        >
            <DedicatedPosContent slug={slug} />
        </Suspense>
    )
}

async function DedicatedPosContent({ slug }: { slug: string }) {
    ...
    // Sort and filter in memory for immediate grid display
