...
export function OnboardingWizard({ userId, profile }: { userId: string, profile?: any }) {
    ...
    return (
        <div className="w-full max-w-2xl mx-auto p-1 sm:p-3 min-h-full flex flex-col justify-center relative">

            <div className="mb-2" />

            {/* Dynamic Progress Indicator */}
            {/* Form Steps */}
            <form className="relative min-h-[340px] sm:min-h-[380px]" onSubmit={handleSubmit(onSubmit)} noValidate>
                {/* Step 1: Owner Details (Name & Phone) */}
                {step === 1 && (
                    <div key="step1">
                        <Card className="border border-zinc-200 dark:border-zinc-800 bg-white/95 dark:bg-zinc-900 overflow-hidden rounded-2xl">
                            ...
                            <CardContent className="px-8 pb-8 pt-4 space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <Input
                                            ...
                                            {...register("userName")}
                                            className="h-14 text-lg font-bold bg-zinc-50 dark:bg-zinc-800/50 border-2 border-zinc-200 dark:border-zinc-700/50 focus:border-violet-600 focus:ring-4 focus:ring-violet-500/10 rounded-xl px-4"
                                            autoFocus
                                        />
                                        {isUserNameValid && (
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            inputMode="numeric"
                                            pattern="[6-9][0-9]{9}"
                                            className="h-14 pl-16 text-lg font-bold bg-zinc-50 dark:bg-zinc-800/50 border-2 border-zinc-200 dark:border-zinc-700/50 rounded-xl focus:border-violet-600 focus:ring-4 focus:ring-violet-500/10 pr-10"
                                ...
                                <Button type="button" onClick={nextStep} className="w-full h-13 text-base font-black bg-zinc-950 dark:bg-white text-white dark:text-zinc-950 hover:bg-zinc-800 dark:hover:bg-zinc-100 rounded-xl" size="lg">
                        ...
                        <Card className="border border-zinc-200 dark:border-zinc-800 bg-white/95 dark:bg-zinc-900 overflow-hidden rounded-2xl">
                            ...
                            <CardContent className="px-8 pb-8 pt-4 space-y-6">
                                <div className="space-y-4">
                                    ...
                                    <div className="relative">
                                        <Input
                                            ...
                                            className="h-14 text-lg font-bold bg-zinc-50 dark:bg-zinc-800/50 border-2 border-zinc-200 dark:border-zinc-700/50 focus:border-primary focus:ring-4 focus:ring-primary/10 rounded-xl px-4 uppercase pr-10"
                                            autoFocus
                                        />
                                ...
                                <div className="flex gap-4 pt-2">
                                    <Button type="button" variant="outline" onClick={prevStep} className="flex-1 h-13 font-black text-base border rounded-xl bg-white dark:bg-zinc-800/50 hover:bg-zinc-50">
                                        Back
                                    </Button>
                                    <Button
                                        type="button"
                                        ...
                                        className="flex-[2] h-13 text-base font-black rounded-xl bg-primary hover:bg-primary/90 text-white disabled:opacity-60"
                                        size="lg"
                                    >
                            ...
                            <CardContent className="px-8 pb-8 pt-4 space-y-6">
                                <div className="space-y-4">
                                    ...
                                    <Input
                                        ...
                                        {...register("gstin")}
                                        maxLength={15}
                                        className="h-14 font-mono tracking-widest text-lg bg-zinc-50 dark:bg-zinc-800/50 border-2 border-zinc-200 dark:border-zinc-700/50 focus:border-indigo-600 focus:ring-4 focus:ring-indigo-500/10 rounded-xl px-4 uppercase"
                                        autoFocus
                                    />
                                    {errors.gstin && (
                                        <p className="text-xs text-red-600 font-black flex items-center gap-1.5">
                                ...
                                <div className="flex gap-4 pt-2">
                                    ...
                                    <Button type="button" onClick={nextStep} className="flex-[2] h-13 text-base font-black bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl" size="lg">
                                        Next Step <ArrowRight className="ml-2 h-5 w-5" />
                                    </Button>
                                </div>
                            </CardContent>
                ...
                {step === 4 && (
                    <div key="step4">
                        <Card className="border border-zinc-200 dark:border-zinc-800 bg-white/95 dark:bg-zinc-900 overflow-hidden rounded-2xl">
                            ...
                            <CardHeader className="pt-6 px-8">
                                <div className="w-11 h-11 rounded-xl bg-emerald-600 text-white flex items-center justify-center mb-4">
                                    <MapPin size={24} />
                                </div>
                            ...
                            <CardContent className="px-8 pb-8 pt-4 space-y-4">
                                ...
                                <div className="flex gap-3 pt-8 w-full">
                                    <Button
                                        ...
                                        variant="outline"
                                        onClick={prevStep}
                                        className="flex-none w-24 sm:w-28 h-13 text-base font-black rounded-xl"
                                        disabled={loading}
                                    >
                                    ...
                                    <Button
                                        type="submit"
                                        disabled={loading}
                                        className="flex-1 min-w-0 h-13 text-base font-black rounded-xl bg-emerald-600 hover:bg-emerald-500"
                                    >
                                        {loading ? (
                                            <span className="flex items-center gap-2">
                                                <Loader2 className="h-4 w-4" /> Activating...
                                            </span>
                                        ) : (
            ...
            {/* Subtle Footer */}
            <p className="mt-6 text-center text-[10px] font-bold text-zinc-400 uppercase tracking-widest">
